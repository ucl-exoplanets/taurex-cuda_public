...
_molecule_func_code = {
        ...
        'CO' : compute_ray_sigma(
                                n='1.0 + 32.7e-5 * (1.0 + 8.1e-3 / _wl_p2)',king=1.016),
        'NH3' : compute_ray_sigma(
                                n='1 + 37.0e-5 * (1. + 12.0e-3 / _wl_p2)'),
        'H2O' : (lambda ns_air='(1 + (0.05792105/(238.0185 - (10000/(_wn*_wn))) + 0.00167917/(57.362-(10000/(_wn*_wn)))))',delta=0.17:
